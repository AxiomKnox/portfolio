...
## Details
[Paragraph describing the challenge and your solution]

## Architecture
[A simple Mermaid diagram or description of how the system is put together]

## Tech Stack
- Frontend: [React/Next/etc]
- Backend: [Go/Node/Python]
- DevOps: [AWS/Terraform/GHA]
